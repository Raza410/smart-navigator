      ...
      <Box maw={200} pos="relative">
        ...
        >
          {(transitionStyle) => (
            ...
            >
              <div className="bg-white rounded-lg shadow-lg mt-2 p-4 relative w-72 md:w-96">
                <button
                  ...
                  {mapStyles.map((style, index) => (
                    <div
                      ...
                      className={`flex-shrink-0 p-2 hover:bg-gray-100 rounded ${
                        selectedStyle.title === style.title ? "bg-gray-200" : ""
                      }`}
                    >
                      <img
                        src={style.img}
